...
4. Choose one visual hierarchy: title, evidence, source.
5. Build the figure as editable HTML/SVG unless the user explicitly asks for a raster image.
