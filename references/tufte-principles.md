...
- Colors or patterns used for decoration, not encoding
- 3D effects, shadows, gradients without purpose
- Clip art, icons, or illustrations that do not carry data
...
**Shrink principle:** Graphics can often be reduced while maintaining readability and gaining impact. Consider:
- Sparklines
...
2. **Integrity:** Does the visual effect match the data effect?
...
7. **Context:** Is all necessary context provided?
